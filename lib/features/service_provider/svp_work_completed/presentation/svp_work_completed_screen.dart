...
import '../../../../helpers/ui_helpers.dart';
import '../controller/svp_work_completed_screen_controller.dart';
...
class SvpWorkCompletedScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final controller = Get.put(SvpWorkCompletedScreenController());
  ...
  Widget _buildContent(SvpWorkCompletedScreenController controller) {
