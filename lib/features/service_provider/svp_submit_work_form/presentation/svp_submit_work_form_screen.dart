...
///
///
/// todo::: showing the image and video into one place
///
///
///
///
...
class _SvpSubmitWorkFormScreenState extends State<SvpSubmitWorkFormScreen> {
  ...
  // Function to get file type icon
  Widget _getFileTypeIcon(String path, {bool isFromApi = false}) {
    final fileName = path.toLowerCase();
    if (fileName.endsWith('.mp4') ||
        fileName.endsWith('.mov') ||
        fileName.endsWith('.avi') ||
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  /// Section: All Media Files (Combined - Existing + New)
                  Obx(() {
                    final totalFiles = controller.apiAttachments.length + controller.mediaFiles.length;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Display existing API attachments
                              if (controller.apiAttachments.isNotEmpty)
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Wrap(
                                      ...
                                      children: controller.apiAttachments.asMap().entries.map((entry) {
                                        ...
                                        final attachment = entry.value;
                                        final mediaUrl = controller.getImageUrl(attachment.url);
                                        final isVideo = _isVideoFile(attachment.url);
                                        final isImage = _isImageFile(attachment.url);

                                        return GestureDetector(
                                          onTap: () {
                                            if (isVideo) {
                                              _showMediaInDialog(mediaUrl, "Proof File ${index + 1}", 'video');
                                            } else if (isImage) {
                                              _showMediaInDialog(mediaUrl, "Proof File ${index + 1}", 'image');
                                            }
                                          },
                                          child: Container(
                                            width: 80.w,
                                                ...
                                                Positioned(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Icon(
                                                          isVideo ? Icons.cloud_done : Icons.cloud_done,
                                                          color: Colors.white,
                                                          size: 10,
                                                        ),
                                                        SizedBox(width: 2.w),
                                  ...
                                  children: [
                                    ...
                                    ListView.separated(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        final isVideo = _isVideoFile(mediaFile.path);
                                        final isImage = _isImageFile(mediaFile.path);
                                        final fileIndex = controller.apiAttachments.length + index + 1;
                                        ...
                                        return Container(
                                          ...
                                          child: Row(
                                            children: [
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Center(
                                                          child: Column(
                                                            mainAxisAlignment: MainAxisAlignment.center,
                                                            children: [
                                                              Icon(Icons.videocam, color: Colors.white, size: 20.h),
                                                              SizedBox(height: 2.h),
                                                              Text(
                                                                'Video',
                                                                style: TextStyle(
                                              ...
                                              IconButton(
                                                icon: Icon(Icons.remove_circle_outline, color: Colors.red, size: 22.h),
                                                onPressed: () async {
                                                  await controller.removeMediaFile(index);
                                                },
                                              ),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        "Tap on images/videos to preview. Green border indicates uploaded files, orange indicates new files.",
                                        style: TextStyle(
                                          fontSize: 11.sp,
                                          color: Colors.grey.shade700,
                                          fontStyle: FontStyle.italic,
                  ...
                  /// Section: Add New Files
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                        "Add More Proof Files",
                        style: TextFontStyle.headline16w700c202020StyleSatoshi,
                      ),
                      UIHelper.verticalSpace(12.h),
                      Container(
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow("Completion Date:", controller.completionDateController.text),
              _buildDetailRow("Duration:", "${controller.durationTimeController.text} days"),
              _buildDetailRow("Total Proof Files:", "$totalMedia"),
              if (controller.apiAttachments.isNotEmpty)
                _buildDetailRow("  - Already uploaded:", "${controller.apiAttachments.length}"),
              if (controller.mediaFiles.isNotEmpty)
                _buildDetailRow("  - New files to upload:", "${controller.mediaFiles.length}"),
              SizedBox(height: 12.h),
              Divider(),
              SizedBox(height: 12.h),
              _buildDetailRow("Initial Cost:", "\$${controller.initialCost.value.toStringAsFixed(2)}"),
