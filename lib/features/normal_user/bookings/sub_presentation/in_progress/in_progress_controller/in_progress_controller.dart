...
class InProgressBookingsController extends GetxController {
  ...
  Future<void> getInProgressBookings() async {
    try {
      ...
      errorMessage.value = '';
      log('Starting to fetch in-progress bookings...');
      ...
      log('Making API call to: ${AppUrl.inProgressBookings}');
      ...
      if (response.isSuccess && response.jsonResponse != null) {
        ...
        if (response.jsonResponse!['success'] == true) {
          ...
          log('Found ${results.length} in-progress bookings');
      ...
      log('Exception in getInProgressBookings: $e');
    } finally {
      isLoading.value = false;
  ...
  @override
  void onInit() {
    log('InProgressBookingsController initialized');
