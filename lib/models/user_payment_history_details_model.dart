...
///
///
/// todo:: matching the data pass with imtiaz vai details screen
///
///
///
...
class UserPaymentHistoryDetailsModel {
  ...
  String get serviceProviderID => serviceBooking?.providerDetailsId ?? '';
  ...
  Map<String, dynamic> toNavigationArguments() {
    return {
      ...
      'paymentHistoryDetails': this, // Include full model for details screen
    };
  }
}
