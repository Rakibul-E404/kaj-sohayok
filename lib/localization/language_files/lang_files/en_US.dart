...
Map<String, String> englishLanguage = {
  ...
  'fill_your_details': 'Please Fill In Your Details.',
  'user_name': 'User Name',
  ...
  'enter_your_date_of_birth': 'Please Enter Your Date Of Birth',
  ...
  'add_demo_image': 'Add Demo Images',
  'browse_files_from_there': 'Browse File From Here',
  'image_max_uploading_limit': 'Max Image Uploading Limit :',
  'upload_image': 'Upload Image',
  'total_balance': 'Total Balance',
  'total_withdrawl_balance': 'Total Withdrawal Balance',
  'transection_history': 'Transactions History',
  'no_transaction_history_available': 'No Transaction History Available',
  ...
  'please_enter_bank_branch_name': 'Please enter bank branch',
  'bank_routing_number': 'Bank Routing Number',
  'please_enter_account_holder_number': 'Please enter bank account holder name',
  ...
  'withdrawl_amount': 'Withdrawal Amount',
  ...
  'loading_in_progress_job': 'Loading in-progress jobs...',
  'no_jobs_in_progress': 'No jobs in progress',
  'active_jobs_will_appear_here': 'Active jobs will appear here',
  'failed_to_load_in_progress_bookings': 'Failed to load in-progress bookings',
  ...
  'no_new_files_to_upload': 'No new files to upload',
  'no_valid_files_to_upload': 'No valid files to upload',
  'files_uploaded_successfully': 'file(s) uploaded successfully',
  'failed_to_upload_files': 'Failed to upload files',
  'upload_failed': 'Upload Failed',
  'submit_work_form': 'Submit Work Form',
  'proof_of_work_completed_information': 'Proof Of Work Complete Information',
  'select_date': 'Select Date',
  'type_days_in_numbers': 'Type Day\'s In Numbers',
  'existing_proof_files': 'Existing Proof Files',
  'proof_file': 'Proof File',
  'tap_on_any_file_to_see_preview':
      'Tap on any file to preview. Videos will play in a video player.',
  'add_new_proof_files': 'Add New Proof Files',
  ...
  'warning': 'Warning',
  'please_select_completation_date': 'Please select completion date',
  'please_enter_duration_time': 'Please enter duration time',
